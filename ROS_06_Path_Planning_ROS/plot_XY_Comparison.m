function plot_XY_Comparison(x_des, y_des, x_state, y_state, x_output, y_output, theta_state, triangle_SideLength, filenameXY)
    ...
    plot(x_output, y_output, ':', 'LineWidth', 1.5);
    ...
    legend('Desired Path','State Feedback','Output Feedback','Initial Desired Position','Final Desired Position','interpreter','latex','location','best');
