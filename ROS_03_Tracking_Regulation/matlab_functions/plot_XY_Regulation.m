function plot_XY_Regulation(x, y, theta, x_f, y_f, filenameXY)

    figure
    title('Posture Regulation with Singularity','Interpreter','Latex');
    hold all
    ...
    legend('Actual Trajectory','Initial Position','Final Desired Position','interpreter','latex','location','southeast');
